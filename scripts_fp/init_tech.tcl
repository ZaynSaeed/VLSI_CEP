...
#
# Modified for EE476L Lab 3 (Floorplanning FIR Filter)
# Author: Rehan Naeem / Adapted for IIC-OSIC Environment
...
if {[file exists "../.cockpitrc"]} {
    ...
    if {![info exists pdk_dir]} {
        # ✅ Correct path for IIC-OSIC Docker setup
...
set pdk_pad_lef  /foss/pdks/ihp-sg13g2/bondpad/lef
...
# Prevent IO cells from being used as buffers
set dont_use_cells sg13g2_IOPad*

# Metal track generation
proc makeTracks {} {
